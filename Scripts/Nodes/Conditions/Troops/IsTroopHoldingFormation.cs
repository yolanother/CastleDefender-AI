...
namespace DoubTech.CastleDefender.AI.Nodes.Conditions.Troops{
	...
	[Description("Retruns true if troop members should be holding the formation")]
	public class IsTroopHoldingFormation : ConditionTask<ITroop>{
		...
		{
			return agent.IsHoldingFormation;
		}
	}
}