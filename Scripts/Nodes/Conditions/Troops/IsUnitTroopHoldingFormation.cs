...
namespace DoubTech.CastleDefender.AI.Nodes.Conditions.Troops{
	...
	[Description("Returns true if this unit's troops should be holding/returning to formation")]
	public class IsUnitTroopHoldingFormation : ConditionTask<IUnit>{
		...
		protected override bool OnCheck(){
			return agent.Troop.IsHoldingFormation;
		}
	}
}